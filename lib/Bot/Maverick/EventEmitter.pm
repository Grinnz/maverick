package Bot::Maverick::EventEmitter;
...
Bot::Maverick::EventEmitter - Event emitter role for Maverick
...
events. Used for emitting events from L<Bot::Maverick> and
L<Bot::Maverick::Network>.
...
L<Bot::Maverick>, L<Moo::Role>, L<Mojo::EventEmitter>
