...
Bot::Maverick::Access - Access level management for Maverick

=head1 SYNOPSIS

  use Bot::Maverick::Access ':access', 'valid_access_level', 'channel_access_level';
  my $valid = valid_access_level(ACCESS_BOT_VOICE);
  my $access = channel_access_level('@');

=head1 DESCRIPTION

L<Bot::Maverick::Access> is a module to manage the access levels available for
a L<Bot::Maverick> IRC bot. Commands and other user behavior is often dependent
on the user's access level, either internally or in the channel.
